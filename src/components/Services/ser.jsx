...
const serviceCategories = [
  {
    ...
    services: [
      { name: "Women's haircut – stylist", price: "₹1,500" },
      { name: "Men's haircut – stylist", price: "₹450" },
      { name: "Child haircut (girl)", price: "₹700" },
      { name: "Child haircut (boy)", price: "₹250" },
      { name: "Blowdry – stylist", price: "₹800" },
      { name: "Updo (no wash) – stylist", price: "₹2,000" },
    ],
  },
  {
    ...
    services: [
      { name: "Global colour – short*", price: "₹5,600" },
      { name: "Global NH₃‑free – short*", price: "₹6,700" },
      { name: "Highlights – short*", price: "₹6,700" },
      { name: "Root touch‑up*", price: "₹2,000" },
      { name: "Root touch‑up NH₃‑free*", price: "₹2,200" },
      { name: "Men's global colour*", price: "₹1,700" },
    ],
  },
  {
    id: "hair-treatments",
    ...
    services: [
      { name: "Olaplex stand‑alone – short", price: "₹2,800" },
      { name: "Olaplex curl rebuilding – short", price: "₹6,200" },
      { name: "Perming – short", price: "₹7,300" },
      { name: "Straightening – short", price: "₹6,700" },
      { name: "Hair botox – short", price: "₹10,000" },
      { name: "Botoliss – short", price: "₹11,900" },
    ],
  },
  {
    id: "hair-spa",
    ...
    services: [
      { name: "Spa essence anti‑hairfall – short", price: "₹1,400" },
      { name: "Spa essence anti‑dandruff – short", price: "₹1,400" },
      { name: "Shea butter hair spa – short", price: "₹2,900" },
      { name: "Fiber Clinix hair spa – short", price: "₹3,000" },
      { name: "3 TenX hydra revive hairspa – short", price: "₹3,100" },
      { name: "Botox hair spa – short", price: "₹4,000" },
    ],
  },
];
